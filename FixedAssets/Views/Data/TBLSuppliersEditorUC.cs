...
{
    public partial class TBLSuppliersEditorUC : XtraUserControl
    {
        #region - Var -
        private static readonly log4net.ILog Logger = log4net.LogManager.GetLogger(typeof(TBLSuppliersEditorUC));
        ...
        #endregion
        #region - Fun -
        public TBLSuppliersEditorUC(Datasource.dsData.RoleDetialRow RuleElement)
        {
            InitializeComponent();
        ...
        private void UOW_BeforeCommitTransaction(object sender, DevExpress.Xpo.SessionManipulationEventArgs e)
        {
            // Get NewId
            int id = 0;
            object obj = Classes.Managers.DataManager.GetNewId("TBLSuppliers", "SupplierId");
            if (obj == null)
            {
            ...
            {
                if (item.GetMemberValue("SupplierId") == null)
                {
                    item.SetMemberValue("SupplierId", id);
                    id++;
                }
